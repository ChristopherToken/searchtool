...
<html>
 ...
 <body>
  <br /><br />
  <div class="container">
   <h1 align="center">Search for Sermon</h1>
   <br /><br />
   <div id="search_area">
    <input type="text" name="sermon_search" id="employee_search" class="form-control input-lg" autocomplete="off" placeholder="Search by: Preacher name, Date, Title" />
   </div>
   <br />
   <br />
